...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <div class="fadeIn first">
      <img src="../img/zz_logo.png" style="width: 40%" id="icon" alt="User Icon" />
    </div>

    <!-- Login Form -->
    <form method="POST" action="login_check.php" onSubmit="return Form_Validation(this)">
    ...
    <!-- Remind Passowrd -->
    <div id="formFooter">
      <a class="underlineHover"  name="login" >Developed By ICT(NG)</a>
    </div>
