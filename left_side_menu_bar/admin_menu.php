...
$select_sql_for_user="SELECT * FROM `user_login` WHERE `user_name`='$user_name'";
...
<div class="col-sm-3 col-md-3 col-lg-3" style="background-color:#0C2D48; min-height:100%; ">					
	...
	<h3>
		<img src="img/new.jpg" style="width: 30px; height:30px; margin-bottom: 4px; background: #ffffff;" class="img-circle"/>
		<span class="text-primary" style="color:#FFFFFF">Software Technology</span>
	</h3>
...
<!-- Add All Your Left Side Menu=>Submenu From Here in Accordion Menu -->
	...
	<div id="accordion" class="accordion_menu">
		...
		<h3 style="font-size: 13px; color:#FFFFFF; background:none;">Academic</h3>
		<div style="padding-left:7px;">
		...
		<h3 style="font-size: 13px; color:#FFFFFF; background:none;">Student</h3>
		<div style="padding-left:7px;">
		...
		<h3 style="font-size: 13px; color:#FFFFFF; background:none;">Teacher</h3>
		<div style="padding-left:7px;">
		...
		<h3 style="font-size: 13px; color:#FFFFFF; background:none;">Department</h3>
		<div style="padding-left:7px;">
		...
		<h3 style="font-size: 13px; color:#FFFFFF; background:none;">Stuff</h3>
		<div style="padding-left:7px;">
